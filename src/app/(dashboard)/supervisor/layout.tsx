    ...
    return (
        <div className="min-h-screen bg-[#ffffff] dark:bg-[#0f172a]">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex-shrink-0 flex items-center gap-3">
                                ...
                                <div className="hidden sm:block">
                                    ...
                                    <div className="mt-0">
                                        <span className="text-xs font-medium text-white/75">Supervisor Portal</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="flex">
                ...
                {/* Sidebar */}
                <aside className={`
                    fixed lg:sticky top-16 left-0 z-40 w-64 h-[calc(100vh-4rem)] bg-white dark:bg-[#1e293b] border-r border-gray-100 dark:border-gray-700/40 transition-transform duration-300 ease-in-out flex flex-col
                ...
                `}>
                    ...
                    {/* Profile + Settings */}
                    <SidebarProfile profileHref="/supervisor/profile" onSettingsClick={() => setShowSettings(true)} />
                </aside>
